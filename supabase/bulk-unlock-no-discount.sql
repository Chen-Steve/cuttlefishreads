-- -----------------------------------------------------------------------------
-- Remove bulk-buy discount
--
-- Bulk unlock now charges the full list price of remaining purchasable
-- chapters (no 10% off). Translator still earns 70% of list; platform 30%.
--
